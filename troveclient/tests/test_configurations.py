...
class ConfigurationTest(TestCase):
    def setUp(self):
        ...
        configurations.Configuration.__init__ = Mock(return_value=None)
...
class ConfigurationsTest(TestCase):
    def setUp(self):
        ...
        configurations.Configurations.__init__ = Mock(return_value=None)
        self.configurations = configurations.Configurations()
        self.configurations.api = Mock()
        self.configurations.api.client = Mock()

        self.orig_base_getid = base.getid
        base.getid = Mock(return_value="configuration1")
    ...
    def test_list(self):
        ...
        self.configurations._list = Mock(side_effect=side_effect_func)
    ...
    def test_get(self):
        ...
        self.configurations._get = Mock(side_effect=side_effect_func)
